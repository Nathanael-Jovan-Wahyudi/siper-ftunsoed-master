<x-dashboard-layout>
    ...
    <div class="search-bar" style="margin-bottom: 30px;">
        <input 
            ...
            style="width: 100%; max-width: 400px; padding: 10px 15px; border: 1px solid #ddd; border-radius: 8px; font-size: 14px;"
        >
    </div>

    <p class="section-title" style="font-size: 18px; font-weight: 600; margin-bottom: 15px; color: #2c3e50;">
        Daftar Ruangan Fakultas Teknik
    </p>
        ...
        <tbody id="ruangan-tbody">
            @forelse($ruangans ?? [] as $index => $ruangan)
                <tr style="border-bottom: 1px solid #ecf0f1;">
                    ...
                    <td style="padding: 12px 15px;">
                        <a href="{{ route('peminjam.ruangan.detail', $ruangan->ruang_id) }}" style="color: #3498db; text-decoration: none;">
                            Lihat Detail
                        </a>
                    </td>
                </tr>
